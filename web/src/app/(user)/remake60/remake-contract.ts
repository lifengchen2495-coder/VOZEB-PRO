...
export type RemakeEditablePatch = Partial<Pick<RemakeProject, "title" | "sourceVideo" | "sourceCopy" | "productInfo" | "productScript" | "storyboardScript" | "copyStrategy" | "voice" | "modelSelection" | "references" | "groups" | "frames" | "copyBlocks">>;
...
export function normalizeRemakeProject(value: unknown): RemakeProject {
    ...
    return {
        ...
        productInfo: stringValue(project.productInfo),
        productScript: stringValue(project.productScript),
        storyboardScript: stringValue(project.storyboardScript),
        mergedVideo: normalizeMediaAsset(project.mergedVideo),
        mergedVideoInputVersion: stringValue(project.mergedVideoInputVersion) || undefined,
