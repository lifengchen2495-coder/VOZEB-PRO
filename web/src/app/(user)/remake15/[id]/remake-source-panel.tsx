...
export function RemakeSourcePanel({
    ...
    const sourceCopy = project.sourceCopy || (project.copy.optionRaw === REMAKE_NO_NARRATION_TEXT ? REMAKE_NO_NARRATION_TEXT : "");
        ...
        <aside className="flex h-full min-h-0 flex-col bg-card text-card-foreground" aria-label="来源视频与原文案">
            ...
            <div className="min-h-0 flex-1 overflow-y-auto">
                ...
                <section className="p-3">
                    ...
                    <p className="mt-2 text-xs leading-5 text-muted-foreground">有口播时按原顺序分配到 4 个三帧区间并完成补全校对；无口播时只保留分镜描述。</p>
                </section>
            </div>
        </aside>
    );
