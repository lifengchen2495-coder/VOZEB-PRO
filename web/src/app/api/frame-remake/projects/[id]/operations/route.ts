import { FRAME_REMAKE_ANALYSIS_STAGES, type FrameRemakeAnalysisStage } from "@/lib/frame-remake-contract";
...
export async function POST(request: Request, context: { params: Promise<{ id: string }> }) {
    ...
    try {
        ...
        const project = await startFrameRemakeOperation(user.id, id, body.data.revision, kind, body.data.groupId, undefined, body.data.analysisStage as FrameRemakeAnalysisStage | undefined);
