...
export function remakeProductionInputSnapshot(project: RemakeProductionInputProject, groupIds?: readonly string[]): string {
    ...
    return JSON.stringify({
        ...
        productScript: project.productScript,
        ...
        references: {
            ...
            character: mediaInput(project.references.character),
            characterSupplement: mediaInput(project.references.characterSupplement),
            audio: mediaInput(project.references.audio),
        },
...
function generationInput(generation: GenerationInput) {
    return {
        ...
        attemptNo: generation.attemptNo ?? 0,
        needsReview: generation.needsReview === true,
        result: mediaInput(generation.result),
    };
}
