...
const POSTGRES_TABLES = [
    ...
    "remake15_projects",
    "remake60_projects",
    "remake_product_projects",
    "remake_person_projects",
    "omni_clothing_projects",
    "omni_remake_projects",
    "bangbang_projects",
    "frame_remake_projects",
...
const POSTGRES_SCHEMA_OBJECTS = [
    ...
    "remake_projects_user_updated_idx",
    "remake15_projects_user_updated_idx",
    "remake60_projects_user_updated_idx",
    "remake_product_projects_user_updated_idx",
    "remake_person_projects_user_updated_idx",
    "omni_clothing_projects_user_updated_idx",
    "omni_remake_projects_user_updated_idx",
    "bangbang_projects_user_updated_idx",
    "frame_remake_projects_user_updated_idx",
