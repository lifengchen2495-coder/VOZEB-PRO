...
export type RemakeProductionInputProject = {
    ...
    references: { product?: MediaInput; character?: MediaInput; characterSupplement?: MediaInput; background?: MediaInput; audio?: MediaInput };
    groups: Array<{
        ...
        videoPrompt: string; videoGeneration: GenerationInput;
    }>;
};
